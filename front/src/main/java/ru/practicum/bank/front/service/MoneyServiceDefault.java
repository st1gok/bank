...
@Service
public class MoneyServiceDefault implements MoneyService {
    private final CashClient cashClient;
    private final TransferClient transferClient;
    private final AccountsService accountsService;
    private final UserService userService;

    public MoneyServiceDefault(CashClient cashClient, TransferClient transferClient, AccountsService accountsService, UserService userService) {
